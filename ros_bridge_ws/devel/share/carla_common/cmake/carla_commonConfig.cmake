...
if("TRUE" STREQUAL "TRUE")
  set(carla_common_SOURCE_PREFIX /opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_common)
  set(carla_common_DEVEL_PREFIX /opt/carla_ws/ros_bridge_ws/devel)
  ...
  set(carla_common_INSTALL_PREFIX /opt/carla_ws/ros_bridge_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'carla_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_common/${idir}'.  ${_report}")
    endif()

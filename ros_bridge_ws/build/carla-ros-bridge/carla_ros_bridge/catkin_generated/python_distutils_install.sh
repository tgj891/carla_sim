...
echo_and_run cd "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_ros_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_ros_bridge/setup.py" \
     \
    build --build-base "/opt/carla_ws/ros_bridge_ws/build/carla-ros-bridge/carla_ros_bridge" \
    install \
    --root="${DESTDIR-/}" \

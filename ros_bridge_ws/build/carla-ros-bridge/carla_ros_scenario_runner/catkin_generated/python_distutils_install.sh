...
echo_and_run cd "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_ros_scenario_runner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_ros_scenario_runner/setup.py" \
     \
    build --build-base "/opt/carla_ws/ros_bridge_ws/build/carla-ros-bridge/carla_ros_scenario_runner" \
    install \
    --root="${DESTDIR-/}" \

...
echo_and_run cd "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_walker_agent"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_walker_agent/setup.py" \
     \
    build --build-base "/opt/carla_ws/ros_bridge_ws/build/carla-ros-bridge/carla_walker_agent" \
    install \
    --root="${DESTDIR-/}" \

...
echo_and_run cd "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_twist_to_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_twist_to_control/setup.py" \
     \
    build --build-base "/opt/carla_ws/ros_bridge_ws/build/carla-ros-bridge/carla_twist_to_control" \
    install \
    --root="${DESTDIR-/}" \

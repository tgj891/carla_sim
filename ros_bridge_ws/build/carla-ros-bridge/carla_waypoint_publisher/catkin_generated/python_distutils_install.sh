...
echo_and_run cd "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_waypoint_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/opt/carla_ws/ros_bridge_ws/src/carla-ros-bridge/carla_waypoint_publisher/setup.py" \
     \
    build --build-base "/opt/carla_ws/ros_bridge_ws/build/carla-ros-bridge/carla_waypoint_publisher" \
    install \
    --root="${DESTDIR-/}" \
